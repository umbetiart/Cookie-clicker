...
background1 = ImageTk.PhotoImage(file = "C:/Users/УмбетиарТ/Desktop/project clicker/L.png")
...
our_button = ImageTk.PhotoImage(file="C:/Users/УмбетиарТ/Desktop/project clicker/cookie.png")
...
def every_second():
    global clicks, Clicks_Text, master
    Clicks_Text.set(click)
